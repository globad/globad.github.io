...
!function () {
    var t = this, e = window.fathom.q || [], h = {siteId: "", trackerUrl: ""}, n = {
        set: r, trackPageview: function e(t) {
            ...
            var d = {
                id: (u = 20, l = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", Array(u).join().split(",").map(function () {
            ...
            var u, l;
            var p = h.trackerUrl || (f = document.getElementById("fathom-script"), f ? f.src.replace("tracker.js", "collect") : "");
            var f;
            var m = document.createElement("img");
            m.setAttribute("alt", "");
            m.setAttribute("aria-hidden", "true");
            m.src = p + (v = d, "?" + Object.keys(v).map(function (e) {
                return encodeURIComponent(e) + "=" + encodeURIComponent(v[e])
            }).join("&"));
            var v;
            m.addEventListener("load", function () {
                var e = new Date, t = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 24, 0, 0);
                -1 == s.pagesViewed.indexOf(i) && s.pagesViewed.push(i), s.previousPageviewId = d.id, s.isNewVisitor = !1, s.isNewSession = !1, s.lastSeen = +new Date, function (e, t, n) {
                    e = encodeURIComponent(e), t = encodeURIComponent(String(t));
                    var r = e + "=" + t;
                    n.path && (r += ";path=" + n.path);
                    n.expires && (r += ";expires=" + n.expires.toUTCString());
                    document.cookie = r
                }("_fathom", JSON.stringify(s), {expires: t, path: "/"}), document.body.removeChild(m)
            });
    ...
    function w() {
        return {isNewVisitor: !0, isNewSession: !0, pagesViewed: [], previousPageviewId: "", lastSeen: +new Date}
    }
